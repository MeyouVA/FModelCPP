// Ported from CUE4Parse/UE4/Assets/Exports/Wwise/FWwiseShareSetCookedData.cs
// The banks and media one share set needs loaded, for a single language.
#pragma once
...
namespace CUE4Parse::UE4::Assets::Exports::Wwise
{
    ...
    struct FWwiseShareSetCookedData
    {
        ...
        FWwiseShareSetCookedData() = default;

        explicit FWwiseShareSetCookedData(const FStructFallback& fallback)
        {
