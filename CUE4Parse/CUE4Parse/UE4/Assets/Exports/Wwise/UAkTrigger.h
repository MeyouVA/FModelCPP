// Ported from CUE4Parse/UE4/Assets/Exports/Wwise/UAkTrigger.cs
// A trigger asset; the cooked data stays a generic property bag, as in C#.
#pragma once
...
namespace CUE4Parse::UE4::Assets::Exports::Wwise
{
    ...
    {
    public:
        std::optional<FStructFallback> TriggerCookedData;
        ...
        void Deserialize(FAssetArchive& Ar, int64_t validPos) override
        {
            ...
            TriggerCookedData.emplace(Ar, std::string("WwiseTriggerCookedData"));
        }
    };
}
