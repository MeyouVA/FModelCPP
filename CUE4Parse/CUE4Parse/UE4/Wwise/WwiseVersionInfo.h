// Ported from CUE4Parse/UE4/Wwise/WwiseVersionInfo.cs
#pragma once
...
namespace CUE4Parse::UE4::Wwise
{
    ...
    inline constexpr std::array<uint32_t, 15> SupportedVersions = {
        65,     // Dishonored 1
    ...
    constexpr bool IsSupported(uint32_t version)
    {
        for (const uint32_t supported : SupportedVersions)
