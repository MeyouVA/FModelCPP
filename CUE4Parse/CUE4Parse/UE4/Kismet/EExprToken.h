// Ported from CUE4Parse/UE4/Kismet/EExprToken.cs
#pragma once
...
namespace CUE4Parse::UE4::Kismet
{
    ...
    enum class EScriptInstrumentationType : uint8_t
    {
        Class             = 0,
        ClassScope,
        Instance,
    ...
    enum class EAutoRtfmStopTransactMode : uint8_t
    {
        GracefulExit,
        AbortingExit,
