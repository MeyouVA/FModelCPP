// Ported from CUE4Parse/UE4/Versions/ObjectVersion.cs
// Engine object-serialization version enums. Values auto-increment exactly as in the C# source,
// so the numeric ordering (and any explicitly-pinned values) is preserved.
#pragma once
...
namespace CUE4Parse::UE4::Versions
{
    ...
    enum class EUnrealEngineObjectUE4Version : int32_t
    {
    DETERMINE_BY_GAME = 0,
    ...
    enum class EUnrealEngineObjectUE3Version : int32_t
    {
    DETERMINE_BY_GAME = 0,
    ...
    // Licensee package file version. Read as an int32 from the package summary.
    enum class EUnrealEngineObjectLicenseeUEVersion : int32_t
    {
        LIC_NONE = 0,
        // this needs to be the last line (see note below)
