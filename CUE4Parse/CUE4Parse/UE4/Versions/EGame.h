// Ported from CUE4Parse/UE4/Versions/EGame.cs
...
{
    // Base values for each engine generation. See GameUtils in the C# source.
    // bytes: 04.NN.FF.XX : 04/05=UE4/5, NN=UE4 subversion, FF=Flags (currently not used), XX=game (0=base engine)
    constexpr uint32_t GameUe3Base = 0x3000000;
    constexpr uint32_t GameUe4Base = 0x4000000;
    constexpr uint32_t GameUe5Base = 0x5000000;
    constexpr uint32_t GameUe6Base = 0x6000000;

    // Unscoped enum (mirrors the C# `using static EGame` idiom so GAME_* names are used bare).
    enum EGame : uint32_t
    {
    // bytes: 04.NN.FF.XX : 04/05=UE4/5, NN=UE4 subversion, FF=Flags (curently not used), XX=game (0=base engine)
    GAME_UE4_0 = GameUe4Base + (0 << 16),
    GAME_UE4_1 = GameUe4Base + (1 << 16),
    GAME_UE4_2 = GameUe4Base + (2 << 16),
    GAME_UE4_3 = GameUe4Base + (3 << 16),
    GAME_UE4_4 = GameUe4Base + (4 << 16),
    GAME_UE4_5 = GameUe4Base + (5 << 16),
        GAME_ArkSurvivalEvolved = GAME_UE4_5 + 1,
    GAME_UE4_6 = GameUe4Base + (6 << 16),
    GAME_UE4_7 = GameUe4Base + (7 << 16),
    GAME_UE4_8 = GameUe4Base + (8 << 16),
    GAME_UE4_9 = GameUe4Base + (9 << 16),
    GAME_UE4_10 = GameUe4Base + (10 << 16),
        GAME_SeaOfThieves = GAME_UE4_10 + 1,
    GAME_UE4_11 = GameUe4Base + (11 << 16),
        GAME_GearsOfWar4 = GAME_UE4_11 + 1,
        GAME_DaysGone = GAME_UE4_11 + 2,
    GAME_UE4_12 = GameUe4Base + (12 << 16),
        GAME_Abzu = GAME_UE4_12 + 1,
    GAME_UE4_13 = GameUe4Base + (13 << 16),
        GAME_StateOfDecay2 = GAME_UE4_13 + 1,
        GAME_WeHappyFew = GAME_UE4_13 + 2,
        Game_StyxShardsofDarkness = GAME_UE4_13 + 3,
    GAME_UE4_14 = GameUe4Base + (14 << 16),
        GAME_TEKKEN7 = GAME_UE4_14 + 1,
        GAME_TransformersOnline = GAME_UE4_14 + 2,
    GAME_UE4_15 = GameUe4Base + (15 << 16),
        GAME_ConanExiles = GAME_UE4_15 + 1,
    GAME_UE4_16 = GameUe4Base + (16 << 16),
    ...
    GAME_UE4_17 = GameUe4Base + (17 << 16),
        GAME_AWayOut = GAME_UE4_17 + 1,
    GAME_UE4_18 = GameUe4Base + (18 << 16),
    ...
    GAME_UE4_28 = GameUe4Base + (28 << 16),

    GAME_UE4_LATEST = GAME_UE4_28,

    GAME_UE5_0 = GameUe5Base + (0 << 16),
