// Ported from CUE4Parse/UE4/Versions/FPCGCustomVersion.cs
...
namespace CUE4Parse::UE4::Versions
{
    namespace FPCGCustomVersion
    {
        ...
        inline const FGuid GUID(0x2763920D, 0x0F784B39, 0x986E4BB3, 0xA88D666D);
        ...
        inline Type Get(Readers::FArchive& Ar)
        {
            ...
            if (game < GAME_UE5_3) return SplineSamplerUpdatedNodeInputs;
            if (game < GAME_UE5_4) return UpdateTransferAttributeWithSelectors;
            if (game < GAME_UE5_5) return NoMoreSpatialDataConversionToPointDataByDefaultOnNonPointPins;
            if (game < GAME_UE5_6) return AttributesAndTagsCanContainSpaces;
            if (game < GAME_UE5_7) return AttributePropertySelectorDeprecatePointProperties;
