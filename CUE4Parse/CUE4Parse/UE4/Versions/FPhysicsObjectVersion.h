// Ported from CUE4Parse/UE4/Versions/FPhysicsObjectVersion.cs
...
namespace CUE4Parse::UE4::Versions
{
    namespace FPhysicsObjectVersion
    {
        ...
        inline const FGuid GUID(0x78F01B33, 0xEBEA4F98, 0xB9B484EA, 0xCCB95AA2);
        ...
        inline Type Get(Readers::FArchive& Ar)
        {
            ...
            if (game < GAME_UE4_25) return SerializeGTGeometryParticles;
            if (game < GAME_UE4_26) return GroomWithImportSettings;
            if (game < GAME_UE4_27) return ChaosConvexHasUniqueEdgeSet;
