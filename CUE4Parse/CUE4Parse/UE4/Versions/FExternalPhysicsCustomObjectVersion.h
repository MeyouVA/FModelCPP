// Ported from CUE4Parse/UE4/Versions/FExternalPhysicsCustomObjectVersion.cs
...
namespace CUE4Parse::UE4::Objects::UObject
{
    namespace FExternalPhysicsCustomObjectVersion
    {
        ...
        inline const FGuid GUID(0x35F94A83, 0xE258406C, 0xA31809F5, 0x9610247C);
        ...
        inline Type Get(Readers::FArchive& Ar)
        {
            ...
            if (game < GAME_UE4_24) return BeforeCustomVersionWasAdded;
            if (game < GAME_UE4_25) return SerializeMultiStructures;
            if (game < GAME_UE4_26) return PhysicsMaterialSleepCounterThreshold;
            if (game < GAME_UE4_27) return RemovedAABBTreeFullBounds;
            if (game < GAME_UE5_0) return AddOneWayInteraction;
